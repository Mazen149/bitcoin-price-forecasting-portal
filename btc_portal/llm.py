...
def explain_explore_data_with_llm(dataframe: pd.DataFrame, price_col: str) -> str:
    ...
    prompt = (
        ...
        "1) Key Insights (3-6 bullets)\n"
        "2) Evidence From The Visuals (2-5 bullets; cite specific stats)\n"
        "3) Uncertainty / Limits (1-3 bullets)\n"
...
def explain_forecast_with_llm(
    ...
    prompt = (
        ...
        "Do NOT include advice, action items, or sections like “What to do next”.\n"
        "Use these sections exactly:\n"
        "1) Trend Summary (2-4 bullets)\n"
        "2) Accuracy & Reliability (2-4 bullets)\n"
        "3) Confidence & Uncertainty (1-3 bullets)\n"
